...
class HTML_Node
{
     ...
     * @see select()
     */
    public $selectClass = HTML_Selector::class;
    /**
     ...
     * @see setInnerText()
     */
    public $parserClass = HTML_Parser_HTML5::class;
    /**
     ...
     * @var string
     */
    public $childClass_Text = HTML_Node_TEXT::class;
    /**
     * Name of the class used for {@link addComment()}
     * @var string
     */
    public $childClass_Comment = HTML_Node_COMMENT::class;
    /**
     * Name of the class used for {@link addContional()}
     * @var string
     */
    public $childClass_Conditional = HTML_Node_CONDITIONAL::class;
    /**
     * Name of the class used for {@link addCDATA()}
     * @var string
     */
    public $childClass_CDATA = HTML_Node_CDATA::class;
    /**
     * Name of the class used for {@link addDoctype()}
     * @var string
     */
    public $childClass_Doctype = HTML_Node_DOCTYPE::class;
    /**
     * Name of the class used for {@link addXML()}
     * @var string
     */
    public $childClass_XML = HTML_Node_XML::class;
    /**
     * Name of the class used for {@link addASP()}
     * @var string
     */
    public $childClass_ASP = HTML_Node_ASP::class;
    /**
