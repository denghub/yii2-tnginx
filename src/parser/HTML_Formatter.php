...
class HTML_Formatter
{
     ...
     */
    static public function minify_html($root, $strip_comments = true, $recursive = true)
    {
        if ($strip_comments) {
     ...
     */
    static public function minify_javascript($root, $indent_string = ' ', $wrap_comment = true, $recursive = true)
    {
     ...
     * @return string
     */
    static public function indent_text($text, $indent, $indent_string = '  ')
    {
